...
=======  =========================================================
   ...
   4363  called by a behavioural test
     93  uncalled, and unreachable without a window, an input device
         or the app instance
     72  uncalled, and reachable
=======  =========================================================
...
The 72 are spread across 57 classes:
