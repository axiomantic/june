...
def main():
    ...
    # The project's copyright notice, byte for byte as every hand-written file
    # under sources/ carries it - including the non-breaking space after the
    # first two hashes. A generated file is still a file in this repository.
    print("#\u00a0June - Copyright (c) 2022 Lucio Asnaghi, Gavin Ray")
    print("#")
    print("#\u00a0Licensed and distributed under the")
    print("#   MIT license (license terms in the root directory or at "
          "http://opensource.org/licenses/MIT).")
    print("#")
    print("# This file may not be copied, modified, or distributed except "
